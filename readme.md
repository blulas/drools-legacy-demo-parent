# IBM Business Automation - Decision Manager Open Edition - Demo Parent for legacy Drools

This repository contains the master Maven parent project object model (POM) for all demos related to IBM Decision Manager Open Edition that rely on legacy Drools dependencies.

## Overview

The purpose of the demo parent POM is to provide a single Maven project that manages the group of dependencies for all Decison Manager Open Edition projects that rely on legacy Drools dependencies.  The demo parent POM is divided into several sections, listed as follows:
